    ...
    <el-container>
      <el-aside width="170px">
        <el-col>
          ...
          >
            <el-menu-item index="1" @click="newlyAdded">
              <!-- <template slot="title"> -->
            ...
            <el-menu-item index="3" @click="topicManagment">
              <i class="el-icon-document"></i>
              <span slot="title">管理课题</span>
            </el-menu-item>
            <el-menu-item index="4" @click="personalCenter">
              <i class="el-icon-document"></i>
...
export default {
  ...
  methods: {
    newlyAdded() {
      this.$router.push('/home/teacherHome')
    },
    myTopic() {
      this.$router.push('/home/teacherHome/myTopic')
    },
    topicManagment(index) {
      this.$router.push('/home/teacherHome/topicManagment')
    },
    personalCenter() {
      this.$router.push('/home/teacherHome/personalCenter')
    },
    aaa() {
      console.log(1112);
    },
